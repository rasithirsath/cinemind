...
const Movies = () => {
  ...
  const filterMovies = (query: string, language: string) => {
    ...
    if (language !== "all") {
      filtered = filtered.filter((movie) => movie.language.toLowerCase() === language.toLowerCase());
    }
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="container mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <Tabs value={selectedLanguage} onValueChange={setSelectedLanguage} className="w-fit mx-auto">
            <TabsList className="bg-secondary/50">
              <TabsTrigger value="all" className="data-[state=active]:bg-gold data-[state=active]:text-charcoal">
                All
              </TabsTrigger>
              <TabsTrigger value="tamil" className="data-[state=active]:bg-gold data-[state=active]:text-charcoal">
                Tamil
              </TabsTrigger>
              <TabsTrigger value="english" className="data-[state=active]:bg-gold data-[state=active]:text-charcoal">
                English
              </TabsTrigger>
            </TabsList>
          </Tabs>
